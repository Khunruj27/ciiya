    ...
    <div className="rounded-[26px] border border-black/5 bg-white p-5 shadow-sm">
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-2 text-[24px] font-black tracking-[-0.04em] text-[#1C0617]">
            {status}
          </p>
            ...
            <div className="rounded-[32px] border border-black/5 bg-white p-6 shadow-sm">
              <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div>
                  ...
                  <h2 className="mt-1 text-[30px] font-black tracking-[-0.06em] text-[#1C0617]">
                ...
                <div className="text-left md:text-right">
                  <p
                    className={[
                      'text-[42px] font-black tracking-[-0.08em]',
                      overallScore >= 90
                        ? 'text-green-600'
                        : overallScore >= 70
                          ? 'text-yellow-600'
