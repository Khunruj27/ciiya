...
assert.match(syncDoc, /Device-authenticated R2 upload reservation\/finalization \| Implemented/)
assert.match(syncDoc, /Local queue, stable-file watcher, retries, offline recovery \| Implemented/)
assert.match(syncDoc, /Ciiya Sync desktop shell for macOS and Windows \| Implemented/)
assert.match(syncDoc, /Lightroom Export Selection integration and local-copy workflow \| Implemented/)
assert.match(syncDoc, /Live Folder session UI, Realtime status, telemetry \| Implemented/)
