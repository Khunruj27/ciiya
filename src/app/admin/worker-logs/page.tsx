...
export default async function WorkerLogsPage() {
  ...
  return (
    <main className="min-h-screen bg-ground-sunken p-6">
        ...
        <div className="overflow-hidden rounded-2xl border border-line bg-white shadow-sm">
          <div className="overflow-x-auto">
            <table className="min-w-full text-sm">
              <thead className="bg-ground-sunken">
                <tr>
                ...
                {(logs || []).map((log) => (
                  ...
                  >
                    ...
                    <td className="max-w-lg px-4 py-3">
                      <pre className="overflow-auto rounded-lg bg-ground-sunken p-2 text-xs text-ink-soft">
